...
class ReviewMoodSelectorCard extends StatelessWidget {
  final CheckinMood? value;
  final ValueChanged<CheckinMood> onChanged;

  const ReviewMoodSelectorCard({
    super.key,
    this.value,
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        AppSectionHeader(
          title: context.l10n.dailyReviewMoodLabel,
          dotColor: AppColor.violet,
        ),
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: AppSpacing.s16),
          child: Row(
            children: CheckinMood.values.map((level) {
